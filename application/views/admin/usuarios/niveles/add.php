                    ...
                    <div class="row-fluid">
                        <div class="span6">
                            <div class="control-group">
                                <label>Nombre</label>
                                <input type="text" placeholder="Nombre del nivel" class="span12" name="nivel[nombre]" data-rule-required="true">
                            </div>
                        </div>
                        <div class="span6">
                            <div class="control-group">
                                <label>Descripción</label>
                                <input type="text" placeholder="Descripción del nivel" class="span12" name="nivel[desc]" data-rule-required="true">
                            </div>
                        </div>
					</div>
					
                    <pre><?=print_r($relgas)?></pre>
